...
def show_companies(companies):
    # Wyświetla listę firm kurierskich
    print("Firmy kurierskie: ")
...
def add_company(companies):
    ...
    company_name = input("Podaj nazwę firmy kurierskiej do dodania: ")
    company_location=input("Podaj lokalizację firmy (miasto): ")
    companies.append({"company_name": company_name, "shipments": [], "workers": [], "company_location": company_location})
...
def remove_company(companies):
    # Usuwa firmę z listy
    company_name = input("Podaj nazwę firmy kurierskiej do usunięcia: ")
    company_found = False
    for company in companies:
...
def update_company(companies):
    ...
    old_company_name = input("Podaj nazwę firmy kurierskiej do aktualizacji: ")
    company_found = False
    for company in companies:
...
def companies_map(companies):
    ...
    for company in companies:
        ...
        if latitude_tag and longitude_tag:
            ...
            print(
                f"Firma: {company_name}, Lokalizacja: {company_location}, Szerokość geograficzna: {latitude}, Długość geograficzna: {longitude}")
            folium.Marker(
